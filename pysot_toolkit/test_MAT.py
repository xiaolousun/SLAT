...
parser.add_argument('--name', default='MA_Tracker_100e', type=str,
...
def main():
    ...
    net_path = '/home/xlsun/xlsun/code/SLAT/results/MA_Tracker/checkpoints/ltr/MA_Tracker/MA_Tracker_dp/MixTracking_ep0100.pth.tar'
